...
export function generatePdf(dpgf, lotList, productList) {
    ...
    doc.setFontSize(16);
    doc.text(`Décomposition du Prix Global et Forfaitaire : ${dpgf.name}`, 20, yOffset);
    yOffset += 10;
    ...
    lotList.forEach((lot) => {
        ...
        yOffset += 5;
        const filteredProductsByLotCode = productList.filter((product) => product.lotCode === lot.code);
