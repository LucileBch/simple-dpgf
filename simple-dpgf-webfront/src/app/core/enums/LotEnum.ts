export enum LotEnum {
  VRD_1 = "VRD_1",
  FONDATION_2 = "FONDATION_2",
  SUPERSTRUCTURE_3 = "SUPERSTRUCTURE_3",
  CHARPENTE_4 = "CHARPENTE_4",
  CLOISONNEMENT_5 = "CLOISONNEMENT_5",
  FACADE_6 = "FACADE_6",
  REVETEMENT_7 = "REVETEMENT_7",
  CVC_8 = "CVC_8",
  SANITAIRES_9 = "SANITAIRES_9",
  CFO_10 = "CFO_10",
  CFA_11 = "CFA_11",
  ELEVATEUR_12 = "ELEVATEUR_12",
  PRODUCTION_ELECTRICITE_13 = "PRODUCTION_ELECTRICITE_13",
  ENERGIE = "ENERGIE",
  AUTRE = "AUTRE",
  UNKNOWN = "UNKNOWN",
  NONE = "EMPTY",
...
export function lotNameToLabel(lotName: LotEnum) {
  switch (lotName) {
    case LotEnum.VRD_1:
