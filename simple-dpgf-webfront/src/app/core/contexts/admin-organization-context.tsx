...
export const AdminOrganizationContext =
  React.createContext<AdminOrganizationStore>({} as AdminOrganizationStore);

export function AdminOrganizationContextProvider({
  children,
  ...
  const adminOrganizationStore: AdminOrganizationStore = useMemo(
    () => ({
      organizationList,
      setOrganizationList,
  ...
  return (
    <AdminOrganizationContext.Provider value={adminOrganizationStore}>
      {children}
    </AdminOrganizationContext.Provider>
  );
}

export type AdminOrganizationStore = {
